# -*- coding: utf-8 -*-
# makes all strings here unicode by default ('')
"""_summary_
...
class DataContainer(object):
    ...
    VALID_NAME_LOOKUP = {
        ...
        # Numbers and maths
        'number': ['ONE', 'NUMPAD_ONE', 'TWO', 'NUMPAD_TWO', 'THREE', 'NUMPAD_THREE',
                   'FOUR', 'NUMPAD_FOUR', 'FIVE', 'NUMPAD_FIVE', 'SIX', 'NUMPAD_SIX',
                   'SEVEN', 'NUMPAD_SEVEN', 'EIGHT', 'NUMPAD_EIGHT', 'NINE', 'NUMPAD_NINE',
                   'ZERO', 'NUMPAD_ZERO'],
        'number keys': ['ONE', 'NUMPAD_ONE', 'TWO', 'NUMPAD_TWO', 'THREE', 'NUMPAD_THREE',
                        'FOUR', 'NUMPAD_FOUR', 'FIVE', 'NUMPAD_FIVE', 'SIX', 'NUMPAD_SIX',
                        'SEVEN', 'NUMPAD_SEVEN', 'EIGHT', 'NUMPAD_EIGHT', 'NINE', 'NUMPAD_NINE',
                        'ZERO', 'NUMPAD_ZERO'],
        '1': ['ONE', 'NUMPAD_ONE'],
...
def get_all_valid_keynames():
    """
    get_all_valid_keynames Gets a list of all valid keynames used"
...
def get_valid_keynames(char_or_name, treat_numpad_keys_explicitly=False):
    ...
    /:param treat_numpad_keys_explicitly    if true, will not expand ambiguous keys to numpad keys 
                                            (0 and Numpad 0 have different functions)
    """
    ...
    if treat_numpad_keys_explicitly and 'numpad' not in char_or_name.lower():
        valid_keynames = [
            n for n in valid_keynames if 'numpad' not in n.lower()]
